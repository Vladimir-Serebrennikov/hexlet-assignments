...
public class ProductsController {
    ...
    public ProductDTO update(@RequestBody ProductUpdateDTO productData, @PathVariable Long id) {
        var productOriginal = productRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Not found"));
        updateToEntity(productData, productOriginal);
        productRepository.save(productOriginal);
        var productDTO = toDTO(productOriginal);
        return productDTO;
    }
    // END


    private Product updateToEntity(ProductUpdateDTO productUpdateDTO, Product product) {
